        ...
        <table border="0" align="center">
            <tr >
               <tr>
                ...
                <tr align="center"><td colspan="2"> <br>     &nbsp;&nbsp; &nbsp;&nbsp;   &nbsp;&nbsp; &nbsp;&nbsp;   &nbsp;&nbsp; &nbsp;&nbsp;  <input type="submit" name="submit" id="submit" value="Confirm"> &nbsp;&nbsp; &nbsp;&nbsp;<a href="./Approved.jsp"><input type="submit" name="can" id="can" value="Delete"></a>
