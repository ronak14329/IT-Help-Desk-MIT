...
<p> 
    <form method="post" action="EmailPassword">
        ...
        <table border="0" align="center">
            <tr >
               ...
               <tr>
                ...
                <tr align="center"><td colspan="2"> <br>     &nbsp;&nbsp; &nbsp;&nbsp;   &nbsp;&nbsp; &nbsp;&nbsp;   &nbsp;&nbsp; &nbsp;&nbsp;  <input type="submit" name="submit" id="submit" value="Submit"> &nbsp;&nbsp;<a href="Approved.jsp"><input type="submit" name="refr" id="refr" value="Refresh"></a> &nbsp;&nbsp;<a href="./Confirm.jsp"><input type="submit" name="can" id="can" value="Delete"></a>
