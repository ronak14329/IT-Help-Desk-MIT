...
<p> 
    <form method="post" action="Adminstration">
        
        
        <fieldset >
            <legend align="center"> Successfully send</legend>
            <font align="cener">  Thanks !!!!</font>
         <br>     &nbsp;&nbsp; &nbsp;&nbsp;   &nbsp;&nbsp; &nbsp;&nbsp;   &nbsp;&nbsp; &nbsp;&nbsp;  <input type="submit" name="submit" id="submit" value="Back"> &nbsp;&nbsp;<input type="submit" name="refr" id="refr" value="Refresh"> &nbsp;&nbsp;<input type="submit" name="can" id="can" value="Cancel">
        </fieldset>
    </form>
</p>
