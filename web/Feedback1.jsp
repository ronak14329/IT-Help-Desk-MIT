...
<form>
        ...
        <table border="0" align="center">
            ...
            <tr>
                ...
                <td >
                    <input type="text" name="contact" id="contact" size="60"><br>
            ...
            <tr align="center"><td colspan="2"> <br>     &nbsp;&nbsp; &nbsp;&nbsp;   &nbsp;&nbsp; &nbsp;&nbsp;   &nbsp;&nbsp; &nbsp;&nbsp;  <input type="submit" name="subm" id="subm" value="Submit"> &nbsp;&nbsp;<input type="submit" name="refr" id="refr" value="Refresh"> &nbsp;&nbsp;<input type="submit" name="can" id="can" value="Cancel">
