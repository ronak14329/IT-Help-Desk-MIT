...
<p> 
    <form method="post" action="JDatabase">
        <fieldset >
            <legend align="center"> User Registration Form</legend>
        <table border="0" align="center">
            <tr >
                ...
                <td >
                    <input type="text" name="name" id="N" size="35">
                         <script type="text/javascript">
				var f1 = new LiveValidation('N');
				...
				f1.add(Validate.Format,{pattern: /^[a-zA-Z][a-zA-Z\s]{0,}$/,failureMessage: " Invalid name"});
			</script>
                ...
                <td >
                    <input type="text" name="mail" id="M" size="35">
                        <script type="text/javascript">
				var email = new LiveValidation('M');
                ...
                <td>
                    <input type="number" name="contact"  id="C" size="50" ><br>
                    <script type="text/javascript">
			var f1 = new LiveValidation('C');
                ...
                <td >
                    <input type="text" name="fields"  id="F" size="35"><br>
                    <script type="text/javascript">
				var f1 = new LiveValidation('F');
				f1.add(Validate.Presence,{failureMessage: " It cant be empty"});
		    </script>
                </td>
            </tr><tr>
                <td >
                ...
                <td >You will get on your mail id.
                </td>
            </tr>   
