...
<div class="art-nav-inner">
	<ul class="art-hmenu">
		...
		<li>
                    <a href="./ITSupport.jsp" class="active"><span class="l"></span><span class="r"></span><span class="t">IT Team</span></a>
		</li>	<li>
...
<p>
    ...
    <%
    String query="select Name,MailId,Contactno  from a_register where Type='Support Team'";
